...
namespace Avaruz.FrameWork.Controls.Win.Wizard
{
    ...
    [Designer(typeof(Avaruz.FrameWork.Controls.Win.Wizard.WizardPageDesigner))]
    public class WizardPage : Panel
    {
        ...
        public int OnCloseFromBack(Wizard wiz)
        {
            ...
            PageEventArgs e = new(wiz.PageIndex - 1, wiz.Pages);
