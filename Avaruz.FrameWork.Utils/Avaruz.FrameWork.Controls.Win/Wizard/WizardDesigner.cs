...
namespace Avaruz.FrameWork.Controls.Win.Wizard
{
    ...
    public class WizardDesigner : ParentControlDesigner
    {
        ...
        //
        //				if (ss.PrimarySelection is Avaruz.FrameWork.Controls.Win.Wizard.Wizard)
        //				{
        //					 Avaruz.FrameWork.Controls.Win.Wizard.Wizard wizard =  (Avaruz.FrameWork.Controls.Win.Wizard.Wizard) ss.PrimarySelection;
        ...
        public override DesignerVerbCollection Verbs
        {
            get
            {
                DesignerVerbCollection verbs = [new DesignerVerb("Añadir Página", new EventHandler(HandleAddPage))];
        ...
        private void HandleAddPage(object sender, EventArgs e)
        {
            ...
            DesignerTransaction dt = h.CreateTransaction("Añadir Página");
