...
namespace Avaruz.FrameWork.Controls.Win
{
    public static class PrintDGV
    {
        ...
        private static readonly ArrayList ColumnLefts = [];  // Left Coordinate of Columns
        private static readonly ArrayList ColumnWidths = []; // Width of Columns
        private static readonly ArrayList ColumnTypes = [];  // DataType of Columns
        ...
        private static readonly System.Drawing.Printing.PrintDocument printDoc =
                       new();  // PrintDocumnet Object used for printing
        ...
        private static List<string> SelectedColumns = [];   // The Columns Selected by user to print.
        private static readonly List<string> AvailableColumns = [];  // All Columns avaiable in DataGrid 
        ...
        public static void Print_DataGridView(DataGridView dgv1, string printTitle, bool printAllRows, bool fitToPageWidth)
        {
            ...
            try
            {
                ...
                psd.ShowDialog();
                psd.PageSettings.Margins = new System.Drawing.Printing.Margins(33, 33, 33, 33);
            ...
            try
            {
                ...
                if (PageNo == 1)
                {
                    foreach (DataGridViewColumn GridCol in dgv.Columns)
                    {
                        ...
                        tmpWidth = FitToPageWidth
                            ? (int)Math.Floor((double)(GridCol.Width /
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        ...
                        foreach (DataGridViewCell Cel in GridRow.Cells)
                        {
                            ...
                            if (((Type)ColumnTypes[i]).Name is "DataGridViewTextBoxColumn" or
                            ...
                            else if (((Type)ColumnTypes[i]).Name == "DataGridViewButtonColumn")
                            {
                                ...
                                Bitmap bmp = new(CellButton.Width, CellButton.Height);
                            ...
                            else if (((Type)ColumnTypes[i]).Name == "DataGridViewCheckBoxColumn")
                            {
                                ...
                                Bitmap bmp = new((int)ColumnWidths[i], CellHeight);
                            ...
                            else if (((Type)ColumnTypes[i]).Name == "DataGridViewComboBoxColumn")
                            {
                                ...
                                Bitmap bmp = new(CellComboBox.Width, CellComboBox.Height);
                            ...
                            {
                                Rectangle CelSize = new((int)ColumnLefts[i],
